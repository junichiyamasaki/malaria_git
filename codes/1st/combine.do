...
merge 1:m mhid hl1 using e_MQNCONVERT, generate(_merge3)
...
//蚊帳に関する家計ごとの情報
merge m:1 mhid using e_MQNHHCONVERT, generate(_merge4)
...
label define d 1 "treated" 0 "untreated"
label value d d
...
gen mediex12=ea32+eb32+ec32+ed32
gen mediex6=ea42+eb42+ec42+ed42
...
save e_combine, replace

forvalues X = 1/5{
use C:\Users\J.YAMASAKI\Documents\stata11data\Malaria\1st\e_MOUSTIQUAIRE,clear
...
foreach X in 4 5 6 8 9 10 11 12 13{
...
forvalue i =1/5{
use  e_LISTE_INDIVIDU_MENAGE.dta,replace
...
save  e_LISTE_INDIVIDU_MENAGE_`i'.dta,replace
use e_combine, replace
merge m:1 mqnw`i'ids using e_LISTE_INDIVIDU_MENAGE_`i'.dta,gen(_wmerge`i') keep(master match) 
save e_combine, replace
erase "e_LISTE_INDIVIDU_MENAGE_`i'.dta"
}


do C:\Users\J.YAMASAKI\Documents\stata11data\Malaria\1st\spaweight
save spaweight,replace
use e_combine,clear
merge m:1 miid using spaweight,  nogenerate
save e_combine ,replace
