use individual_list_act_rdt_3rd.dta,replace
...
label var flr15ax "1st activity when out of screen"
label var flr15bx "2nd activity when out of screen"
label value  flr15ax flr15bx flr15x

replace flr15ax=. if flr15ax==9
replace flr15bx=. if flr15bx==9

rename flr15ax flr15axx
rename flr15bx flr15bxx
//1st
...
save  e_LISTE_INDIVIDU_ACT_RDT_3rd.dta,replace
exit
