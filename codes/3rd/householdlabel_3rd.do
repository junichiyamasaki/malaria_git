...
mvdecode a7 a19 a20 a21 a22 k9 k10 k11 h14 h15 ea5 eb5 ec5 c1 k4   k1  k3g k5a k5b k5c k5d k5e k5f k5g k5h k5i k5j k5x  h1 h16 h17 a1 a2 a6 a16 a17 a28, mv(9)
...
*3rd
label var mhid10 "Household ID in the 2nd"
rename h17cx h17cxx
rename h17dx h17dxx
replace h17dxx=. if h17dxx==9 
rename h17ex h17exx
replace h17exx=. if h17exx==9 
label var h17cxx "Did you know of the plan of net distribution campaign before the distribution was actually held (Dec/2009 or Nov2010)?"
label var h17dxx "How many months before the campaign actually was held do you know of the distribution campaign plan?"
label var h17exx "Did you stop buying a new mosquito net by knowing of the campaign?"
label define h17cxx 1 "Yes" 2 "No" 3"I do not know even now" 
label value h17cxx h17cxx
label define h17dxx 1 "0-6months" 2 "7-12months" 3 "I cannot remember"
label value h17dxx h17dxx
label define h17exx 1 "Yes" 2 "No" 
label value h17exx h17exx


label var mh3gx " Same CM that in June 2010 " 
label var mhid10 " Household ID June 2010"  
label var mh3hx " Same person interviewee that in June 2010 " 
label var mh3fx " Same person interviewee that in Dec 2009 " 

save e_MENAGE_3rd,replace
exit
