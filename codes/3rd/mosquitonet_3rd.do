set more off
do codes/3rd/mosquitonetlabel_3rd
...
for num 1/15: replace freemqnX=h5yy if h71==X|h72==X|h73==X|h74==X|h75==X
...
label define freemqn 1 "purchased" 2 "free" 3"big campaign" 9 "missing"
...
save data/intermediate/3rd/e_MQNCONVERT_3rd,replace
...
gen campnet=0
replace campnet=1 if h5yy==3
gen campnet0912=0
replace campnet0912=1 if (h5yy==3&h4==2009&h4ax==12)
gen campnet1001=0
replace campnet1001=1 if (h5yy==3&h4==2010&h4ax==1)
...
save data/intermediate/3rd/e_MQNHHCONVERT_3rd,replace
exit